        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[Save Groot](https://t.me/savegroot)__**\n ",
                    edit,
                    time.time()
                )
            )
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                try:
                    ...
                    logging.info(e)
                    thumb_path = None
                caption = f"{msg.caption}\n\n__Unrestricted by **[Save Groot](https://t.me/savegroot)**__" if msg.caption else "__Unrestricted by **[Save Groot](https://t.me/savegroot)**__"
                await client.send_video(
                    ...
                    progress_args=(
                        client,
                        '**UPLOADING: __[Save Groot](https://t.me/savegroot)__**\n ',
                        upm,
                        time.time()
                    )
                )
                ...
                await client.send_document(
                    ...
                    progress_args=(
                        client,
                        '**UPLOADING:**\n**Bot made by [Save Groot](https://t.me/savegroot)**',
                        upm,
                        time.time()
                    )
                )
